...
export default function InventoryExample() {
  ...
  return (
    <>
      <MetaHead 
        title="Inventory Example - Ice Plant Management Portal"
        description="Example inventory management using MCP architecture."
        keywords={['ice plant', 'management', 'inventory', 'MCP', 'architecture', 'example']}
      />
